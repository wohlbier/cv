...
\setname{John}{Wohlbier, PhD}
\setaddress{Pittsburgh, PA USA}
...
Dr.~Wohlbier is AI Division Advanced Computing Lab Lead and a Principal
Research Scientist at the Carnegie Mellon University Software
Engineering Institute. The Advanced Computing Lab applies world class
expertise to solve advanced computing problems in artificial
intelligence at all scales – edge, cloud, and HPC – that enable
continuous improvement of the warfighter's ability to defend our
nation. The Advanced Computing Lab vision is to provide the warfighter
artificial intelligence solutions that use the latest and most
advanced computing technology at all scales in a timely, reliable, and
safe and secure manner that maximizes warfighter effectiveness.

Wohlbier started his post-doctoral career at Los Alamos National
Laboratory where he spent over a decade working on computational
physics for the US Department of Energy Advanced Simulation and
Computing program. Starting in 2016 Wohlbier spent several years
supporting DoD HPC programs. Wohlbier was the technical lead for the
Software Engineering Institute's involvement in the DARPA
Software Defined Hardware,
Domain Specific System on Chip,
Data Protection in Virtual Environments,
and
Machine Learning and Optimization-guided Compilers for Heterogeneous
Architectures
programs. His current focus is on
hardware-software co-design for for AI applications at the edge and
applications of modern compiler technology to SOSA-aligned
hardware. His interests include computation on modern and emerging
...
\explanation{Principal Research Scientist -- Advanced Computing --
...
\explanationdetail{Advanced computing and performance engineering for
  ...
  Machine Learning and Optimization-guided Compilers for Heterogeneous
  Architectures.
  Perform expert evaluation of DARPA performer
...
\explanationdetail{Proposed performer system evaluation and
  ...
  and
  \href{https://www.darpa.mil/research/programs/mocha-machine-learning}{MOCHA}
  programs.
  Awards: \$5.3M base, additional \$2.5M optional.}
\explanationdetail{Proposed and lead SEI managed, congressional line
  item funded, research and development in
  \href{https://www.sei.cmu.edu/library/rr24-co-design-for-edge-artificial-intelligence/}{Hardware-Software
    Co-design for Edge AI Applications},
  and
  \href{}{MOCHA Compiler Applications to SOSA Hardware}.
  Awards: \$6.5M
  }
