...
Dr.~Wohlbier is AI Division Advanced Computing Lab Lead and a Senior Research Scientist at the Carnegie Mellon University Software Engineering Institute. The Advanced Computing Lab applies world class expertise to solve advanced computing problems in artificial intelligence at all scales – edge, cloud, and HPC – that enable continuous improvement of the warfighter's ability to defend our nation. The Advanced Computing Lab vision is to provide the warfighter artificial intelligence solutions that use the latest and most advanced computing technology at all scales in a timely, reliable, and safe and secure manner that maximizes warfighter effectiveness.

Wohlbier started his post-doctoral career at Los Alamos National Laboratory where he spent over a decade working on computational physics for the US Department of Energy Advanced Simulation and Computing program. Starting in 2016 Wohlbier spent several years supporting DoD HPC programs. Wohlbier is the technical lead for the Software Engineering Institute's involvement in the DARPA Domain Specific System on Chip (DSSoC) and Data Protection in Virtual Environments (DPRIVE) programs. His current focus is on hardware-software co-design for for AI applications at the edge. His interests include computation on modern and emerging hardware, performance engineering, and computational physics.
}
