...
\explanationdetail{Performance engineering for US Navy computational
  ...
  HPCG benchmarks with chip microarchitecures.}
...
\explanationdetail{
  ...
  simultaneous programming of three disimilar processors.
...
\explanationdetail{Applied novel analytic and numerical methods to
  ...
  Traveling Wave Tubes. Still receive occassional requests for code.
}
